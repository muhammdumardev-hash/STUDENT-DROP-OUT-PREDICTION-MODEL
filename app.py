...
# ============================================================
# CUSTOM CSS
# (Fixed: all text now uses dark colors on light backgrounds
#  so it is actually readable. Colored badges/cards keep their
#  own contrasting text colors.)
# ============================================================
